...
# plt.ylim(-10,10)
plt.legend()
plt.title('Sorted Date elasticity -TotalUS-', fontweight = "bold")
plt.ylabel('Elasticidad')
plt.xlabel('Fecha')
plt.show()
```
...
plt.title('Estudio de precios', fontweight = "bold")
color = 'tab:red'
...
plt.title('Volumen ventas California', fontweight = "bold")
plt.ylabel('Volumen Ventas')
plt.xlabel('Año')
plt.show()

df_media['AveragePrice'].plot(kind='bar', label = 'Average Price', color= 'green')
plt.title('Precio venta California', fontweight = "bold")
plt.ylabel('Precio medio')
plt.xlabel('Año')
plt.show()
```
...
plt.yscale('log')
plt.title('Bags segun tipo y fecha (log)', fontweight = "bold")
plt.ylabel('Valor')
plt.xlabel('Fecha')
plt.grid()
plt.legend()
...
# plt.yscale('log')   
plt.grid()
plt.title('Bags segun tipo y fecha', fontweight = "bold")
plt.ylabel('Valor')
plt.xlabel('Fecha')
plt.legend()
plt.show()
...
# plt.yscale('log')   
plt.title('Bags segun tipo y quarter', fontweight = "bold")
plt.ylabel('Valor')
plt.xlabel('Quarter')
plt.grid()
plt.legend()
...
# plt.yscale('log')
plt.title('Volumen ventas greater regions por fecha', fontweight = "bold")
plt.ylabel('Volumen ventas')
plt.xlabel('Fecha')
plt.grid()
plt.legend()
...
```python
df_cleaned_great_regions = df_cp_cleaned[df_cp_cleaned['region_class']=='GreaterRegion']
df_cleaned_great_regions = df_cleaned_great_regions[(df_cleaned_great_regions['Date']<'2017-03-01')&(df_cleaned_great_regions['Date']>'2017-01-15')]
great_regions = pd.unique(df_cleaned_great_regions['region'])
...
# plt.yscale('log')
plt.title('Zoom Volumen ventas por Superbowl', fontweight = "bold")
plt.ylabel('Volumen ventas')
plt.xlabel('Fecha')
plt.grid()
plt.legend()
...
plt.figure(figsize=(10, 6))
sns.heatmap(corr_matrix, annot=True, cmap='coolwarm', fmt='.2f')
plt.title('Matriz de Correlación (Philadelphia)', fontweight = "bold")
...
plt.xscale('log')
plt.grid()
plt.title('Regresion TotalUS con outliers', fontweight = "bold")
plt.figure()
plt.show()
```
...
plt.xscale('log')
plt.grid()
plt.title('Regresion TotalUS Organic sin outliers', fontweight = "bold")
plt.figure()
plt.show()
...
plt.xscale('log')
plt.title('Regresion City Organic', fontweight = "bold")
plt.grid()
plt.figure()
plt.show()
```
...
plt.title("Average Price en West", fontweight = "bold")
plt.ylabel('Average Price')
plt.xlabel('Fechas')
...
```
    ...
    /tmp/ipykernel_24469/2916262540.py:87: SettingWithCopyWarning: 
...
plt.scatter(x = X_to_plot['Date'], y= Y_to_plot, color= 'blue', label= 'Valores Reales')
plt.title('Modelo Total Volume en California' , fontweight = "bold")
plt.ylabel('Total Volume')
plt.xlabel('Fecha')
plt.grid()
plt.legend()
...
```
    ...
    /tmp/ipykernel_24469/1363187133.py:7: SettingWithCopyWarning: 
    A value is trying to be set on a copy of a slice from a DataFrame.
    Try using .loc[row_indexer,col_indexer] = value instead
...
plt.scatter(x = X_to_plot['Date'], y= y_pred_plot, color= 'Skyblue', label= 'Valores Modelo')
plt.scatter(x = X_to_plot['Date'], y= Y_to_plot, color= 'blue', label= 'Valores Reales')
plt.scatter(x = X_for_vol_temp['Date'], y= vol_prediction, color= 'Orange', label= 'Prediccion modelo', alpha = 0.5)
plt.ylabel('Total Volume')
plt.title('Predicción Total Volume mediante modelo', fontweight = "bold")
plt.grid()
plt.legend()
plt.show()
...
```
    ...
    /tmp/ipykernel_24469/2483863802.py:8: SettingWithCopyWarning: 
    A value is trying to be set on a copy of a slice from a DataFrame.
    Try using .loc[row_indexer,col_indexer] = value instead
...
plt.ylim(0,3)
plt.ylabel('Average Price')
plt.title('Prediccion average price mediante modelo + Estimacion volumen', fontweight = "bold")
plt.xlabel('Fecha')
plt.grid()
plt.legend()
plt.show()
...
```
    ...
    /tmp/ipykernel_24469/2537780951.py:12: SettingWithCopyWarning: 
    A value is trying to be set on a copy of a slice from a DataFrame.
    Try using .loc[row_indexer,col_indexer] = value instead
