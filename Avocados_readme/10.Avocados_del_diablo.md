...
![png](output_28_0.png)
> [!NOTE] Por otro lado el Volumen Total si que esta muy relacionado con las ventas de los calibres pequeños (S) y grandes (L).
...
![png](output_30_0.png)
> [!NOTE] Observamos que las ventas de los distintos calibres son muy distintas en cada region. No se aprecia ningun patron de ventas.
### Proporción por tipo de bolsa sobre Total Bags
    
![png](output_32_0.png)
> [!NOTE] Respecto al tamaño de las bolsas, podemos ver que las bolsas pequeñas tienen una mayor venta que las grandes y especialmente las muy grandes.
